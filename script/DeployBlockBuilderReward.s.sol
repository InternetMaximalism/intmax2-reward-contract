...
contract DeployBlockBuilderReward is Script {
    function deploy(uint256 deployerPrivateKey, address contributionContract, address intmaxToken)
        public
        returns (BlockBuilderReward)
    {
        ...
        bytes memory initData =
            abi.encodeWithSelector(BlockBuilderReward.initialize.selector, contributionContract, intmaxToken);
